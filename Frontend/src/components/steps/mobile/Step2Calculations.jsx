...
export default function Step2Calculations({ metrics, patientData, onProceed, onBack }) {
    ...
    return (
        <div className="section dd-plan-step">
            <div className="dd-step-header mb-8">
            ...
            <NutritionAssessmentPanel assessment={assessment} compact />

            <div className="form-actions step-actions flex justify-between pt-6 mt-6 border-t border-emerald-100 na-step-actions">
